...
export default function App() {
  ...
  return (
    <div className={`h-screen overflow-hidden ${theme === 'dark' ? 'bg-slate-900 text-white' : 'bg-[#F9FAFB] text-slate-900'} flex flex-col font-sans selection:bg-indigo-100 selection:text-indigo-900 transition-colors duration-200`}>
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-[#0014CC] focus:text-white focus:rounded-lg">
        Skip to content
      </a>
      <Header 
        activeTab={activeTab} 
